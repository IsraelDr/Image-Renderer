...
public class renderTest {
    ...
    public void renderImage() {//
        ...
        Sphere moon = new Sphere(new Point3D(5, -100, 20),
                3,new Color(255,255,255),new Material(1,1,20));
        ...
        Camera camera2 = new Camera(new Point3D(-20, 0, 4),
