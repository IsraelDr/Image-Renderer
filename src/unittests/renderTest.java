...
public class renderTest {
    ...
    public void renderimageloop() {//
        for(int i=0;i<10;i++) {
            Plane p1 = new Plane(new Point3D(100, 0, 0), new Vector(-2, 0, -1), new Color(102, 153, 255), new Material(1, 1,1,1, 20));
            Plane p2 = new Plane(new Point3D(0, 0, 0), new Vector(0, 0, 1), new Color(0, 100, 0), new Material(1, 0,1,1, 20));

            Sphere middle2 = new Sphere(new Point3D(5, 0, 5),
                    5, new Color(0, 20, 100), new Material(1, 0.5,1,1, 20));
            Triangle triangle1 = new Triangle(new Point3D(-1, 0, 10), new Point3D(-1, 0, 5), new Point3D(-1, -3, 10), new Color(0, 20, 200), new Material(1, 1,1,1, 20));
    ...
    public void TubeTest(){
        Plane p1=new Plane(new Point3D(100,0,0),new Vector(-2,0,-1),new Color(102,153,200),new Material(1,1,1,0,20));
        Plane p2=new Plane(new Point3D(0,0,0),new Vector(0,0,1),new Color(0,255,0),new Material(1,0,1,0,20));

        Sphere middle2 = new Sphere(new Point3D(5, 0, 7),
                5,new Color(0,20,100),new Material(1,1,0,0.5,20));
        Sphere sun = new Sphere(new Point3D(80, 0, 60),
                40,new Color(255,255,150),new Material(0.5,0.5,1,1,20));
        Triangle triangle1=new Triangle(new Point3D(-1,0,12),new Point3D(-1,0,10),new Point3D(-1,-1,12),new Color(0,20,200),new Material(1,1,1,1,20));
        Camera camera2 = new Camera(new Point3D(-10, 0, 6),
                new Vector(1, 0, 0), new Vector(0, 1, 0));
        ...
        SpotLight Spotlight = new SpotLight(
                new Color (255,255,255),new Vector(1,0,2),
                new Point3D(0,0,4),
                1,0.00001,0.000001
        );
