...
public class SceneTest {
    ...
    public void setCamera() {
        ...
        Scene scene = new Scene("test camera0");
        scene.setCamera(camera);
        Ray rayTest = scene.getCamera().constructRayThroughPixel(pixelX,pixelY,i,j,screenDistance,screenWidth,screenHeight);
        ...
        Scene scene2 = new Scene("test camera2");
        scene2.setCamera(camera2);
        Ray rayTest2 = scene2.getCamera().constructRayThroughPixel(pixelX2,pixelY2,i2,j2,screenDistance2,screenWidth2,screenHeight2);
        ...
        Scene scene3 = new Scene("test camera3");
        scene3.setCamera(camera3);
        Ray rayTest3 = scene3.getCamera().constructRayThroughPixel(pixelX3,pixelY3,i3,j3,screenDistance3,screenWidth3,screenHeight3);
